...
## Overview
GRIND is a local-first, AI-powered productivity tracker. It uses a React-based frontend, local browser storage for data persistence, and the Groq API for intelligent log analysis. It includes voice-to-text capabilities via the native browser Web Speech API.
...
Since GRIND is a Client-Side Application (SPA/PWA), the "infrastructure" is primarily the user's browser and the external Groq API.
